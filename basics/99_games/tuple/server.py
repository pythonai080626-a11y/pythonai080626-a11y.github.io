# -*- coding: utf-8 -*-
"""
server.py  --  Lesson 19 TUPLE QUIZ.  One server, two pages.
...
Endpoints
    ...
    POST /api/answer      {"name":..., "q":n, "chosen":"b" | "(7,)" | null}
    POST /api/override    {"name":..., "q":n}        teacher: count it as right
    POST /api/accept      {"q":n, "text":"7,"}       teacher: also a valid answer
...
def main():
    ...
    print('=' * 60, flush=True)
    print('  TUPLE QUIZ  --  lesson 19  --  %d questions, %d seconds each'
